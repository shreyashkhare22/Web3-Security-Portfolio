...
Every protocol is:
- A capital flow system
- A trust boundary graph
- A game theory problem
- A state machine under stress

My reviews focus on:
- Capital drain vectors
- Accounting desync
- Precision loss & rounding exploitation
- Signature replay & EIP-712 edge cases
...
| RadCipher  | AuditVault Challenge week 4 | - |  | [Results](https://x.com/radcipher/status/2027331835038957747?s=20) |
| RadCipher  | AuditVault Challenge week 6 | - |  | [Results](https://x.com/radcipher/status/2032406317483139276?s=20) |
